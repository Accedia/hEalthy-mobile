export default [
  ...
  'If you want to speed up the ripening of a pineapple, so that you can eat it faster,' +
  ' then you can do it by standing it upside down (on the leafy end).',
  ...
  'Canadian neurosurgeon Dr. Wilder Penfield, while operating on epilepsy patients,' +
   ' discovered the ‘Toast Centre’ of the human brain, which is wholly dedicated to detecting when toast is burning!',
  ...
  'Hundreds and Thousands (Sprinkles, Nonpareils, Jimmies) are small round balls' +
  ' of brightly colored sugar used as decorations on cakes, cookies, trifles and other desserts.' +
  ' Their use dates back at least to the early 19th century.',
